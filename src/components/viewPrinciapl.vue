<template>
  <v-app>
    ...
    <div class="barra-superior">
      ...
      <h1 class="titulo">Registro de edificios certificados con Norma E.030</h1>
      ...
      <div class="opciones">
        ...
        <a
          ...
          class="my-linktop"
          @click="btnReq()"
          :class="{ 'my-linktop': true, active: mostrarRequi }"
          >Requisitos</a
        >
        <div id="dividermenutopL" class="border border-vertical" />

        <a id="dashboard" class="my-linktop" @click="btnDash()">Dashboard</a>
        <!--<div id="dividermenutopL" class="border border-vertical" />
    ...
    <div class="barra-inferior">
      ...
      >
      <div id="dividermenubot" class="border border-vertical" />
      <span class="my-link" style="color: #0032ff; text-decoration: none"
        >Registro de edificios certificados con Norma E.030</span
      >
    </div>
    <!-- final inferior -->
    <!-- EMD HEADER -->
    ...
    >
      ...
      <contRequisitos v-show="mostrarRequi"></contRequisitos>
    </v-navigation-drawer>
    <!-- END MENU -->
    ...
    <div id="contenedor" style="">
      <iframe
        ...
        src="https://ide.igp.gob.pe/geovisor/estaciones-e030/"
...
import contRequisitos from "./contRequisitos.vue";
...
const ids = [
  ...
  "widgets_Search_Widget_39",
  "widgets_HomeButton_Widget_41",
  "widgets_Coordinate_Widget_44",
  "widgets_Scalebar_Widget_43",
];
...
export default {
  ...
  methods: {
    ...
    btnDash() {
      window.open(
        "https://ide.igp.gob.pe/portal/apps/dashboards/4cd091bba5a6428bb59b2cabc4bb1dd9"
      );
    },
    btnFuncion() {
      this.ocultarTodo();
